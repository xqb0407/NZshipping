		...
		<form id="formData" class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="itemDesc" id="itemDesc" required
						lay-verify="required" placeholder="请输入详情页的代码" value=""
						class="layui-input" />
				</div>
			</div>
			 <!--选择分类 联级-->
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					class="layui-textarea" style="width: 650px; height: 100px;"></textarea>
				</div>
			</div>
		...
		layui.use(['layer', 'table','form','upload'], function ()
		        {
					...
					form.on('submit(*)',function(){
						...
						// var itemDesc=$('[name=itemDesc]').val()
						// var cid=$('[name=cid]').val;
						// var image=$('[name=image]').val;
						// var sellPoint=('[name=sellPoint]').val;
						$.ajax({
							type:"post",
							url:"goods/addGoods",
							// data:{
