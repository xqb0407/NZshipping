...
<body>
	...
	<!-- <blockquote class="layui-elem-quote">欢迎!!!"${USER_SESSION.username}"登录农汇购商城后台管理系统</blockquote> -->
		<fieldset class="layui-elem-field">
		  ...
		  <div class="layui-field-box">
			<img  class="layui-upload-img layui-circle userFaceBtn userAvatar"  id="face" name="face">
			...
			<span class="layui-badge" id="username" >123</span>
        ...
        <div class="layui-row layui-col-space15">
		  ...
		  <div class="layui-col-md13">
		    <div class="layui-card">
		      ...
		      <div class="layui-card-body" style="height:308px;">
		        <div class="layui-carousel" id="test1">
		          <div carousel-item="" style="width: 100%;">
		            <div><img src="../layui/images/5.jpg" style="width: 100%;"></div>
		            <div><img src="../layui/images/7.jpg" style="width: 100%;"></div>
		            <div><img src="../layui/images/4.jpg" style="width: 100%;"></div>
		            <div><img src="../layui/images/1.jpg" style="width: 100%;"></div>
		            <div><img src="../layui/images/2.jpg" style="width: 100%;"></div>
		            <div><img src="../layui/images/3.jpg" style="width: 100%;"></div>
					<div><img src="../layui/images/8.png" style="width: 100%;"></div>
		          </div>
		        </div>
		      </div>
		    </div>
  ...
  //待办事项
		...
		$.ajax({
		type:"GET", 
			url:"/demo/table/user?page=1&limit=40000", 
			dataType:"json", 
	  ...
	  $.ajax({
	  type:"GET", 
	  	url:"http://"+OrderIp()+":8894/order/getOrder", 
	  	dataType:"json", 
		success:function(resp){ 
			var data = resp.data;
			console.log(data); 
