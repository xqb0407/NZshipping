...
<form class="layui-form layui-row" id="form1" style="padding-top: 30px;">
	<div class="layui-col-md3 layui-col-xs12 user_right">
		<div class="layui-upload-list">
			<img class="layui-upload-img layui-circle userFaceBtn userAvatar" id="userFace" src="">
			<input type="hidden" name="face"  />
		</div>
		<button type="button" class="layui-btn layui-btn-primary userFaceBtn" name="face1"><i class="layui-icon">&#xe67c;</i> 掐指一算，我要换一个头像了</button>
	</div>
	<div class="layui-col-md6 layui-col-xs12">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="tel" value="" name="phone" placeholder="" lay-verify="phone" class="layui-input userPhone">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" value="" name="email" placeholder="" lay-verify="email" class="layui-input userEmail">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">自我评价</label>
			<div class="layui-input-block">
				<textarea name="msg" value=""  class="layui-textarea myself"></textarea>
			</div>
		</div>
			...
			function(resp){
				...
				if(resp.status==200){
						...
						$('[name=email]').val(data[0].email);
						 $('#userFace').attr('src',data[0].face);
						$('[name=msg]').text(data[0].msg);	
						$('[name=sex]').each(function(i){
							var checkd= $(this).attr('title');
							if(checkd == data[0].sex){
								console.log(checkd)
								$(this).attr('checked','');
								$('[name=sex]').not($(this)).removeAttr('checked');
