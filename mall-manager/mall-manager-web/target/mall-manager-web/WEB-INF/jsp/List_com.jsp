...
<div>
    <table id="banner"  class="layui-laypage-em" lay-filter="banner"></table>
</div>
<div id="formData" style="width:700px;display:none;padding-top:15px;">
	<form class="layui-form" id="bannerForm">
		...
		<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="itemDesc" id="itemDesc" placeholder="请输入详情页的代码" required lay-verify="required" value="" class="layui-input" />
			    </div>			    
		</div>
...
var upload;
var laydate;
        layui.use(['layer', 'table','form','upload','laydate','laytpl'], function ()
        {
            table = layui.table;
            layer = layui.layer;
            form =layui.form;
            ...
            //--------------方法渲染TABLE----------------
             table.render({
                ...
                , cols: [[
                    ...
                    ,{ field: 'id', title: '商品ID', width: 160,align:'center',templet:function(d){
                    ...
                    layer.open({
                        ...
                        yes: function(index, layero){
                        	...
                        	$.post('/editItem',$('#bannerForm').serialize(),function(data){
                                if (data.status=200)
                                {
									//parent.layui.table.reload('testReload',{page:{curr:$(".layui-laypage-curr em").next().html()}});
									//parent.layui.table.reload(testReload,{page:{curr:$(".layui-laypage-em").next().html()}}); //主要代码
