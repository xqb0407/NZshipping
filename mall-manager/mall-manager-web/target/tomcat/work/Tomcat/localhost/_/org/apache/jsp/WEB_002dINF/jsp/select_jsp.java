 ...
 * Generated at: 2019-11-26 01:38:26 UTC
...
public final class select_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \t<div style=\"height:40px;width:70px;float:left;line-height:40px;\">分类名:</div>\n");
      out.write("        <input type=\"text\" class=\"layui-input\" style=\"display:inline-block;width:250px;float:left;\" id=\"keyword\" name=\"keyword\" value=\"\" lay-verify=\"\" placeholder=\"请输入分类名\" autocomplete=\"off\">\n");
      ...
      out.write("\t\t            <i class=\"layui-icon\">&#xe654;</i>添加分类\n");
      out.write("\t\t        </a>\n");
      out.write("\t\t    </div>\n");
      ...
      out.write("\t\t\t    <label class=\"layui-form-label\">分类名称</label>\n");
      out.write("\t\t\t    <div class=\"layui-input-block\">\n");
      out.write("\t\t\t      <input type=\"text\" name=\"typeName\" id=\"typeName\" required lay-verify=\"required\" value=\"\" class=\"layui-input\" />\n");
      out.write("\t\t\t    </div>\t\t\t    \n");
      out.write("\t\t</div>\n");
      out.write("\t</form>\n");
      out.write("</div>\n");
      ...
      out.write("                     ,{ field: 'typeId', title: '类型编号', width: 100, align: 'center' }\n");
      out.write("                     , { field: 'typeName', title: '类型名称', width: 300, align: 'center'}\n");
      out.write("                   ,{ field:'typeState', title: '用户状态', width: 112, align: 'center',templet: function(d){\n");
      out.write("                          if(d.typeState==1){\n");
      out.write("                        \t  return \"<input type='checkbox' lay-filter='switchTest' name='\"+d.typeId+\"' lay-skin='switch' lay-text='禁用|正常'>\";\n");
      out.write("                          }else{\n");
      out.write("                        \t  return \"<input type='checkbox' lay-filter='switchTest' name='\"+d.typeId+\"' lay-skin='switch' lay-text='禁用|正常' checked>\";\n");
      out.write("                          }\n");
      out.write("                \t }\n");
      ...
      out.write("\t\t\t\t\t\tdata:\"typeId=\"+id+\"&state=\"+2,\n");
      out.write("\t\t\t\t\t\tsuccess:function(data){\n");
      out.write("\t\t\t\t\t\t\tif(data==\"success\"){\n");
      out.write("\t\t\t\t\t\t\t\tlayer.msg('禁用分类成功！',{icon:1,time:2000});\n");
      out.write("\t\t\t\t\t\t\t}else{\n");
      out.write("\t\t\t\t\t\t\t\tlayer.msg('禁用分类失败！请重试！',{icon:5,time:2000});\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t});\n");
      out.write("\t\t\t\t}else{\n");
      ...
      out.write("\t\t\t\t\t\ttype:\"post\",\n");
      out.write("\t\t\t\t\t\turl:\"goodsType/changeTypeState\",\n");
      out.write("\t\t\t\t\t\tdata:\"typeId=\"+id+\"&state=\"+1,\n");
      out.write("\t\t\t\t\t\tsuccess:function(data){\n");
      out.write("\t\t\t\t\t\t\tif(data==\"success\"){\n");
      out.write("\t\t\t\t\t\t\t\tlayer.msg(\"启用分类成功！\",{icon:1,time:2000});\n");
      out.write("\t\t\t\t\t\t\t}else{\n");
      out.write("\t\t\t\t\t\t\t\tlayer.msg(\"启用分类失败！请重试！\",{icon:5,time:2000});\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t});\n");
      out.write("\t\t\t\t}\n");
