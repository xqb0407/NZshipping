...
import org.nzy.mapper.TbItemDescMapper;
...
public class ItemListServiceImpl implements ItemListService {
	 ...
	 */
	@Override
	public FjnyResult editItem(TbItem tbItem, TbItemDesc tbItemDesc) {
		TbItemExample example=new TbItemExample();
		...
		example1.createCriteria().andItemIdEqualTo(tbItem.getId());
		tbItemDescMapper.updateByExampleSelective(tbItemDesc, example1);
	 ...
	 */
	@Override
	public FjnyResult addGoods(TbItem tbItem,TbItemDesc tbItemDesc) {
		tbItem.setStatus((byte) 2);
		tbItem.setPrice(tbItem.getPrice());
		tbItemMapper.insert(tbItem);
		System.out.println("itemID"+tbItem.getId());
		tbItemDesc.setItemId(tbItem.getId());
		System.out.println("tbItemDesc:"+tbItemDesc.toString());
