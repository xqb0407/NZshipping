...
public interface ItemListService {
	...
	FjnyResult editItem(TbItem tbItem,TbItemDesc tbItemDesc);//修改商品信息

	FjnyResult deleteitem(TbItem tbItem);//删除商品

	FjnyResult addGoods(TbItem tbItem,TbItemDesc tbItemDesc);//添加商品
	...
	//FjnyResult addGoods(TbItem tbItem,TbItemDesc tbItemDesc);
